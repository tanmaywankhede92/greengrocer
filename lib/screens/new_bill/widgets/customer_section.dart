    ...
    return Container(
      ...
      child: Card(
        child: Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.person, size: 18, color: AppTheme.primaryRed),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(customer!.name, style: TextStyle(color: AppTheme.textPrimary, fontWeight: FontWeight.w600, fontSize: 14)),
              ...
              if (customer!.currentDue > 0)
                Container(
                  ...
                  child: Text('Due: ${AppUtils.formatCurrency(customer!.currentDue)}',
                      style: TextStyle(color: AppTheme.error, fontSize: 11, fontWeight: FontWeight.w600)),
                ),
